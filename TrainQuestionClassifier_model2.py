...
# keywords-set contains two words.
#
...
print('----- !!!!! Running the train_question_classifier_in_two_word !!!!! -----')
...
def text_to_features(txt):
    ...
    try:
        ...
        vec = CountVectorizer(analyzer='word', ngram_range=(2, 2)).fit([txt])
...
save_classifier = open('../pickle_files/BernoulliNB_classifier_model2.pickle', 'wb')
pickle.dump(BernoulliNB_classifier, save_classifier)
save_classifier.close()

save_classifier = open('../pickle_files/MultinomialNB_classifier_model2.pickle', 'wb')
pickle.dump(MultinomialNB_classifier, save_classifier)
save_classifier.close()

save_classifier = open('../pickle_files/LogisticRegression_classifier_model2.pickle', 'wb')
pickle.dump(LogisticRegression_classifier, save_classifier)
save_classifier.close()

save_classifier = open('../pickle_files/SGDClassifier_classifier_model2.pickle', 'wb')
pickle.dump(SGDClassifier_classifier, save_classifier)
save_classifier.close()

save_classifier = open('../pickle_files/LinearSVC_classifier_model2.pickle', 'wb')
pickle.dump(LinearSVC_classifier, save_classifier)
save_classifier.close()

save_classifier = open('../pickle_files/KNeighbors_classifier_model2.pickle', 'wb')
pickle.dump(KNeighbors_classifier, save_classifier)
save_classifier.close()

save_classifier = open('../pickle_files/DecisionTree_classifier_model2.pickle', 'wb')
pickle.dump(DecisionTree_classifier, save_classifier)
save_classifier.close()

save_classifier = open('../pickle_files/voting_classifier_model2.pickle', 'wb')
pickle.dump(question_classifier, save_classifier)
save_classifier.close()

save_data = open('../pickle_files/keywords_model2.pickle', 'wb')
